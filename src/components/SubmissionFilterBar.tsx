import type { FormSettings, UserProfile, SubmissionStatus } from '../types/schema'
...
export default function SubmissionFilterBar({ value, onChange, forms, employees, resultCount }: Props) {
